...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CJEnvironmentKit/CJEnvironmentKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TSDemo_Environment/TSDemo_Environment.framework"
fi
